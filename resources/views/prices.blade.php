  ...
  <div id="content">
    ...
    <section class="section bg-primary">
      <div class="container text-center">
        ...
        <p class="text-5 text-white mb-4">Envía y recive dinero entre bancos, realiza pagos en más de 10 bancos en todo el Perú con las comisiones más bajas y desde la comodidad de tu casa.</p>
